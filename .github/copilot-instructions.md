...
- [x] Clarify Project Requirements - Python script for Space Engineers blueprint armor block replacement

- [x] Scaffold the Project - Manual file creation completed

- [x] Customize the Project - Full implementation with XML parsing and armor block mapping
...
- [x] Launch the Project - Command-line usage documented in README.md
